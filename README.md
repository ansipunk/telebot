...
[![GoDoc](https://godoc.org/github.com/ansipunk/telebot?status.svg)](https://godoc.org/github.com/ansipunk/telebot)
...
```bash
go get -u github.com/ansipunk/telebot
```
...
import (
	...
	tele "github.com/ansipunk/telebot"
)
...
[here](https://godoc.org/github.com/ansipunk/telebot#pkg-constants).
...
implementations:
```go
import "github.com/ansipunk/telebot/middleware"
```
...
[here](https://pkg.go.dev/github.com/ansipunk/telebot#Option).
